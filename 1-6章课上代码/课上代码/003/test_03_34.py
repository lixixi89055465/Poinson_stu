...
class ZhouZhou(TypedDict):
    ...
    precision: Annotated[Optional[str], None, '人物面板属性的持久力,从ABCDE中选一个']
    growth: Annotated[Optional[str], None, '人物面板属性的持久力,从ABCDE中选一个']
    range: Annotated[Optional[str], None, '人物面板属性的持久力,从ABCDE中选一个']
