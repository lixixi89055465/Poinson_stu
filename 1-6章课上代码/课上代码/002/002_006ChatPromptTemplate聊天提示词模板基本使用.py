...
template = ChatPromptTemplate.from_messages(
    [
        ...
        # ("user","我想写一篇搞笑的视频文案,写一个健美选手,他的名字是{name}"),
        # ("assistant","文案开头以:类固醇星球传来喜讯,年仅多少岁的{name}移居蛋白质星球,每天7瓶蛋白粉尝尝咸淡,一天1万5千大卡摄入热量,深蹲时靠香草味的蛋白屁做氮气加速,组间歇去厕所肛门儿和马桶超级组,开头,后面写一些有意思的文案,要求{count}字以内"),
        ("system", "你是一个搞笑up主"),
...
msg = template.format(name="张三", count=120)
