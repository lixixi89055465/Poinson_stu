# -*- coding: utf-8 -*-
# @Time : 2025/11/14 13:51
# @Author : nanji
# @Site : 
# @File : test_002_024.py
# @Software: PyCharm 
# @Comment :
import os
...
s1 = MaxMarginalRelevanceExampleSelector.from_examples(
    ...
    # 它基于 Hugging Face 的 sentence-transformers 库来实现。
    # 借助这个类，你能够使用 Hugging Face 模型中心的众多预训练语言模型，把文本数据转换为数值向量，
    # 这些向量可以用于语义搜索、文本相似度计算等自然语言处理任务。
    # 在使用 langchain 进行示例选择等任务时，HuggingFaceEmbeddings 可以作为 OpenAIEmbeddings 的替代方案，
    # 它允许你在不依赖 OpenAI API 的情况下生成文本嵌入。
    FAISS,  #
