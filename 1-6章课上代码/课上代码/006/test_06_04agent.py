...
prompt = ChatPromptTemplate.from_messages(
    [
        ...
        # scratchpad暂存器,#这个是下面的创建调用过工具的agent的可选输入值占位符
    ]
)
...
agenta_executor = AgentExecutor(agent=agent, tools=tools, verbose=True)
query = '你好,我是秦始皇,告诉我哈尔滨市2025年5月17日天气预报'
ai_msg = agenta_executor.invoke({
    "messages2": [HumanMessage(content=query)]
})
print('ai_msg:', ai_msg)
print('output=:', ai_msg['output'])
