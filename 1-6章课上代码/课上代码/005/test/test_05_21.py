...
multi_retriever = MultiQueryRetriever.from_llm(retriever, llm)
# 他的本质是一条链,执行的时候需要invoke,stream,
print("muti_retriever=", muti_retriever)
dic1 = multi_retriever.to_json()
import json
...
docs = multi_retriever.invoke({"question": "如何把动态库安装到越狱手机上"})
print("docs=", docs)
