...
def rag_fun(url, tag, question):
    ...
    vectorstore = Chroma.from_documents(split_documents, embedding)
    ...
    print("压缩后返回的文档是:")
    for i, v in enumerate(result_compression_docs):
    ...
    ai_msg = chain.invoke({
        "result_compression_docs": result_compression_docs, "question": question
    })
    print('ai_msg:', ai_msg)
